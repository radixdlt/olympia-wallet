<template>
  <div class="flex flex-col overflow-y-auto relative bg-white w-full flex-1">
    ...
    >
      ...
      <input
        v-model="name"
        class="w-full border-t-0 border-r-0 border-l-0 py-5 border-b border-rBlack leading-8 focus:ring-0 focus:outline-none focus:border-rGreen mb-36 max-w-sm border"
