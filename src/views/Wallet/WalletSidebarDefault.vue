<template>
  <div class="w-60 px-5 py-8 flex flex-col">
    <div class="flex">
      <add-hardware-wallet-btn
        @connectHardwareWallet="$emit('connectHW', true)"
      />
...
import AddHardwareWalletBtn from '@/components/AddHardwareWalletBtn.vue'
import { AccountT } from '@radixdlt/application'

const WalletSidebarDefault = defineComponent({
  components: {
    AccountListItem,
    AddHardwareWalletBtn
  },
