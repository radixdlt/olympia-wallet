<template>
  <div data-ci="wallet-view" class="flex flex-row h-screen relative">
    ...
    <div class="flex flex-col w-full">
      ...
      <div class="bg-white py-5 text-center flex flex-row items-center justify-center px-28 border-t border-rRed">
        <div>
        ...
        <div class="max-w-2xl" v-else>{{ $t('wallet.babylonIsHere') }}</div>
      </div>
    </div>
