...
const StakeListItem = defineComponent({
  ...
  computed: {
    ...
    explorerUrl (): string {
      return this.validator ? `https://releasenet-explorer.radixdlt.com/#/validators/${this.validator.address.toString()}` : 'https://releasenet-explorer.radixdlt.com/#/validators/'
    }
  },
