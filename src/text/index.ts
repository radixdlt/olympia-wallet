...
const messages = {
  en: {
    ...
    settings: {
      ...
      nodeDisclaimer: 'Select the gateway that the Wallet will connect to, or add a new gateway of your choice. The choice of gateway also selects which network the Wallet will use.',
      ...
      nodeAddressLabel: 'Gateway Address',
      nodeNetworkLabel: 'Network',
      addCustomNodeLabel: 'Add Custom Gateway Address:',
      addNodeButton: 'add gateway',
      confirm: 'Confirm',
