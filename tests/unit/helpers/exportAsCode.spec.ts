...
describe('sanitizeName', () => {
  it('should limit, replace and add end of name character', () => {
    ...
    expect(sanitizeName('TestTestTestTestTestTestTest 😁')).to.equal('TestTestTestTestTestTestTest _}')
    expect(sanitizeName('abcdefghijklmnopqrstuvwxyz0123456789')).to.equals('abcdefghijklmnopqrstuvwxyz0123}')
    expect(sanitizeName('🤣🤣🤣🤣🤣🤣🤣🤣🤣🤣1234567890🤣🤣🤣🤣🤣🤣🤣🤣🤣🤣1234567890')).to.equal('__________1234567890__________}')
    expect(sanitizeName('Hello HelloHello Hello 🤣🤣 🤣🤣 🤣🤣 🤣🤣')).to.equal('Hello HelloHello Hello __ __ _}')
    expect(sanitizeName('✋🏼✋🏼✋🏼✋🏼✋🏼✋🏼✋🏼✋🏼✋🏼✋🏼✋🏼✋🏼✋🏼✋🏼✋🏼✋🏼✋🏼✋🏼✋🏼✋🏼✋🏼✋🏼✋🏼✋🏼✋🏼✋🏼✋🏼✋🏼✋🏼✋🏼')).to.equal('______________________________}')
    expect(sanitizeName('🤣🤣🤣🤣🤣🤣🤣🤣🤣🤣🤣🤣🤣🤣🤣🤣🤣🤣🤣🤣🤣🤣🤣🤣🤣🤣🤣🤣🤣🤣')).to.equal('______________________________}')
    expect(sanitizeName('Test😁')).to.equal('Test_}')
    expect(sanitizeName('Compound Emojis 🫱🏻‍🫲🏽')).to.equal('Compound Emojis ___}')
  })
})
